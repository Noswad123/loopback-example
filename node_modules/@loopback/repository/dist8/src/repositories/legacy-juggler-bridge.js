...
const relation_factory_1 = require("./relation.factory");
var juggler;
(function (juggler) {
...
class DefaultCrudRepository {
    ...
    setupPersistedModel(definition) {
        ...
        this.modelClass = dataSource.createModel(definition.name, properties, Object.assign({ strict: true, strictDelete: true }, definition.settings));
     ...
     */
    _createHasManyRepositoryFactoryFor(relationName, targetRepo) {
        const meta = this.entityClass.definition.relations[relationName];
        return relation_factory_1.createHasManyRepositoryFactory(meta, targetRepo);
    }
    ...
    save(entity, options) {
        ...
        if (id == null) {
            ...
            return this.replaceById(id, entity, options).then(result => result ? new this.entityClass(entity.toObject()) : null);
        }
    }
