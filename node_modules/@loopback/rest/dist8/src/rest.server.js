...
let RestServer = class RestServer extends context_1.Context {
    ...
    _setupOpenApiSpecEndpoints() {
        ...
        this._expressApp.get(['/swagger-ui', '/api-explorer'], (req, res) => this._redirectToSwaggerUI(req, res));
    }
    ...
    static(path, rootDir, options) {
        ...
        if (re.test('/')) {
            throw new Error('Static assets cannot be mount to "/" to avoid performance penalty.');
        }
