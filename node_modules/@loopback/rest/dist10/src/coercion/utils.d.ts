 ...
 */
export declare function getOAIPrimitiveType(type?: string, format?: string): "password" | "object" | "string" | "number" | "binary" | "boolean" | "date" | "array" | "integer" | "float" | "double" | "byte" | "date-time" | "long" | undefined;
