...
import { ControllerBooter, RepositoryBooter, DataSourceBooter, ServiceBooter } from './booters';
/**
...
export declare class BootComponent implements Component {
    booters: (typeof ControllerBooter | typeof RepositoryBooter | typeof ServiceBooter | typeof DataSourceBooter)[];
    /**
     *
